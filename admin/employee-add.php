<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if($_FILES['image']['size'] < 5*1024*1024 && $_FILES['image']['size'] > 0){
            ...
            // Seed employee Data to Database
            $name = $_POST['name'];
            ...
            $sql = "INSERT INTO `employee`(`name`, `designation`, `phone`, `image`, `email`, `index_number`, `qualification`, `department`, `blood_group`, `birth_date`, `joining_date`, `present_address`, `permanent_address`) VALUES ('$name', '$designation', '$phone', '$image', '$email', '$index_number', '$qualification', '$department', '$blood_group', '$birth_date', '$joining_date', '$present_address', '$permanent_address');";
            ...
            if($result){
                ...
                echo "<script>Failed to Add Employee</script>";
            }
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Home / Employee /<code>New</code> </p>
